...
export class TodoSignalsService {
  ...
  public updateTodos({id,title,description,done}:Todo):void{//quando separamos ja pegamos os valores do objeto
  ...
  public saveTodosInLocalStorage():void{
    ...
    todos && localStorage.setItem(TodoKeyLocalStorage.TODO_LIST, todos) // salva a lista de todo no local storage
  }
