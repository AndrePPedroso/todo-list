...
export class TodoFormComponent {
  ...
  private dialogRefService = inject(MatDialogRef<HeaderComponent>); // aqui colocamos o componente que chama essa modal

  public allTodos = this.todosSignalService.todoState(); // chama todos os todos salvos nesse signal
