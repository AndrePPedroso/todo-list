...
export class TodoCardComponent implements OnInit {
  ...
  public todosList = computed(() => this.todosSignal());
   // quando um valor depende de um valor de outro signal
   //vantagem de usar um computed é que toda a vez que o signal muda esse valor tambem muda
  ngOnInit(): void {
  ...
  private getTodosInLocalStorage() {
    ...
    todosDatas && this.todosSignal.set(JSON.parse(todosDatas)); //seta um novo valor para o signal
  }
